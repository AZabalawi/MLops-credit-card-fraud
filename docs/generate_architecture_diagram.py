...
def lane(x, y, text, color):
    ax.text(x, y, text, fontsize=11, color=color, fontweight="bold", ha="left", va="center")


ax.text(
    6.5,
    7.8,
    "MLOps Phase 1 — System Architecture",
    fontsize=17,
    fontweight="bold",
    ha="center",
    color=COLOR_TEXT,
...
ax.text(
    6.5,
    7.4,
    "Credit Card Fraud Detection Pipeline (DVC + MLflow)",
    fontsize=11,
    ha="center",
    color="#4b5563",
    style="italic",
...
box(
    ...
    4.6,
    0.7,
    "GitHub Repository (single source of truth)\nreproducible from a fresh clone via `dvc repro`",
    COLOR_GIT,
    fontsize=8.4,
)
